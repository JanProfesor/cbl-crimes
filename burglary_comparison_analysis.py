...
df_all = pd.read_csv("processed/final_dataset_all.csv")
df_res = pd.read_csv("processed/final_dataset_residential_burglary.csv")
...
plt.title("Residential Burglary vs All Bruglary Count")
...
plt.title("Linear Fit: Residential Burglary vs All Crime")
plt.xlabel("All Burglary Count")
plt.ylabel("Residential Burglary Count")
plt.legend()
plt.grid(True)
plt.tight_layout()
...
plt.xlabel("Residential Burglary % of Total Crimes")
